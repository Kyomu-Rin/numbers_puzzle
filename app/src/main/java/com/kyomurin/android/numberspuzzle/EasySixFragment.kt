...
import com.kyomurin.android.numberspuzzle.databinding.FragmentEasySixBinding
import com.kyomurin.android.numberspuzzle.databinding.FragmentHardFiveBinding

class EasySixFragment : Fragment() {


    private var _binding: FragmentEasySixBinding? = null
    ...
    override fun onCreateView(
        ...
        Log.i("check", "EasySixFragment onCreateView() called")

        _binding = FragmentEasySixBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Log.i("check", "EasySixFragment onViewCreated() called")
    ...
    private fun createButtonList(buttonsList : List<Button>) : List<Int> {
        ...
        Log.i("check", "EasySixFragment createButtonList() called")
    ...
    private fun onButtonClick(view: View, numbersList: List<Int>) {
        ...
        Log.i("check", "EasySixFragment onButtonClick() called")
        ...
        for (i in 0..35) {
            if (view.id == buttonIds[i]){
                ...
                if (ans == 37) {
                    ...
                    findNavController().navigate(R.id.action_easySixFragment_to_resultFragment)
                }
    ...
    override fun onDestroyView() {
        ...
        Log.i("check", "EasySixFragment onDestroyView() called")
